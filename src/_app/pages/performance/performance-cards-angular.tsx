...
class PerformancePageAngularCardsComponent extends React.Component {
	protected setState;
	state = {
		showRecords: 0,
		data: []
	...
	render() {
		return <React.Fragment>
			<div className='section-header'>Performance tests: Cards, Angular</div>
			<div className='page-content'>
				<p>
					The page renders up to 1000 Angular-based User Cards.
				</p>
...
export const PerformancePageCardsAngular = AnimatedWrapper(PerformancePageAngularCardsComponent);